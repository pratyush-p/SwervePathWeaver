...
public class PratsQuinticHermiteSpline extends PratsSpline {
   ...
   * control vector
   * contains into about the location of the point, its first derivative, and its
   * second derivative.
   *
  ...
  public PratsQuinticHermiteSpline(
