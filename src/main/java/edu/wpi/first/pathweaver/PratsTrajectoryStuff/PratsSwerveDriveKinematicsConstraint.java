 ...
 */
public class PratsSwerveDriveKinematicsConstraint implements PratsTrajectoryConstraint {
   ...
   *                                travel at.
   */
  public PratsSwerveDriveKinematicsConstraint(
  ...
  public double getMaxVelocityMetersPerSecond(
      PratsPose2d poseMeters, double curvatureRadPerMeter, double velocityMetersPerSecond) {
    // Represents the velocity of the chassis in the x direction
    var xdVelocity = velocityMetersPerSecond * poseMeters.getTangent().getCos();

    // Represents the velocity of the chassis in the y direction
    var ydVelocity = velocityMetersPerSecond * poseMeters.getTangent().getSin();
