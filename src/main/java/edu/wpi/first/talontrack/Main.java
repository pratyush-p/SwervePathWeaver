 ...
 * Java launcher that attempts to
 * reflectively access the JavaFX application launcher classes - this will fail
 * because there is no module path;
...
public final class Main {
  public static void main(String[] args) {
    ...
    Application.launch(Talontrack.class, args);
  }
}
