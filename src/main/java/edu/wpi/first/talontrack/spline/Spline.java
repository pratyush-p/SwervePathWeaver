 ...
 * the robot will take when travelling across the field. This class is designed
 * for use with
 * SplineSegment but can be used without or with an alternative implementation
 * so long
 ...
 * an example of setting up drag and drop for the spline and
 * {@link SplineSegment}
 * for an example of setting up drag and drop for segments between splines.
 * <p>
 * Drag and drop is fundamental to talontrack, and implmentors of this interface
 * must abide by the following policies. Between {@link Spline} and
 * {@link edu.wpi.first.talontrack.path.Path}, the
 ...
 * clicked or dragged.
 * see {@link edu.wpi.first.talontrack.path.wpilib.WpilibPath} and
 ...
 * see {@link edu.wpi.first.talontrack.path.wpilib.WpilibPath} for an example.
 ...
 * @see Path
 * @see edu.wpi.first.talontrack.path.wpilib.WpilibPath
 * @see SplineSegment
 */
