...
public final class PathUtil {
     ...
     * coordinates
     * of a waypoint and those right before and after it. This algorithm is based on
     * the
     * <a href="https://arxiv.org/pdf/1010.4615.pdf">following paper</a>.
     *
     * @param p1 the Point2d representing the coordinates of the waypoint before
     *           this one
     * @param p2 the Point2d representing the coordinates of this waypoint
     * @param p3 the Point2d representing the coordinates of the waypoint after this
     *           one
