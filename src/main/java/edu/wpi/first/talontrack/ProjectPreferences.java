...
public class ProjectPreferences {
	...
	private static final String FILE_NAME = "talontrack.json";
		...
		try (BufferedReader reader = Files.newBufferedReader(Paths.get(directory, FILE_NAME))) {
			...
			if (values.exportUnit == null) {
				...
				alert.setContentText(
						"Your project was imported from an older version of talontrack, where the exported units were always in the specified units. "
								+
